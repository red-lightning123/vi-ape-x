...
pub trait ReplayMemory {
    ...
    fn update_priorities_with_td_errors(&mut self, _indices : &[usize], _abs_td_errors : &[f64], _alpha : f64) {
        unimplemented!()
    }
    fn sample_batch_prioritized(&self, _batch_size : usize) -> (Vec<usize>, Vec<f64>, Vec<&Transition>) {
        unimplemented!()
    }
