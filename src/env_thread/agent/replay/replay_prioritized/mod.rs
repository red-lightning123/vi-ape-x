...
impl ReplayMemory for ReplayPrioritized {
    ...
    fn update_priorities_with_td_errors(&mut self, indices : &[usize], abs_td_errors : &[f64], alpha : f64) {
    ...
    fn sample_batch_prioritized(&self, batch_size : usize) -> (Vec<usize>, Vec<f64>, Vec<&Transition>) {
        ...
        for k in 0..batch_size {
            ...
            let (index, priority, transition) = self.transitions.sample_from_range(range_start, range_end, &mut rand::thread_rng());
