...
impl<'a> Game<'a> {
    ...
    pub fn next_frame(&mut self) {
        ...
        match self.score_reader.read_score(self.get_current_frame()) {
            ...
            Err(ScoreReaderError::InvalidColor) => eprintln!("score reader encountered invalid color"),
            Err(ScoreReaderError::InvalidDigitShape) => eprintln!("score reader encountered invalid digit shape")
        }
    }
