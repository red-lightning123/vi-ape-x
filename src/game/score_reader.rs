use crate::{ ImageRef4, ImageRef, ImageOwned };
use crate::Color4;
...
impl ScoreReader {
    ...
    fn read_score_digit(&self, image_ref : &ImageRef4, pos : u32) -> Result<Option<u8>, ScoreReaderError> {
        let image_cropped = image_ref.crop(1680 + 32 * pos, 1680 + 32 * pos + 32 - 8, 142, 142 + 32);
        let image_downscaled = image_cropped.downscale_by_sample(image_cropped.width() / 4, image_cropped.height() / 4);
